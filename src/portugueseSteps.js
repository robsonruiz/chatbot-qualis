...
const PortugueseSteps = [
    ...
    },
    {
      ...
      options: [
        ...
        { value: 11, label: 'Voltar', trigger: 'menuPrincipal'},
      ],
    },
    {
      id: 'vacina',
    ...
    },
    {
      ...
      options: [
        ...
        { value: 8, label: 'Voltar', trigger: 'menuVacinas'},
      ],
    },
    {
    ...
    },
    {
      ...
      options: [
        ...
        { value: 5, label: 'Voltar', trigger: 'menuVacinas'},
      ],
    },
    {
      id: 'eficacia',
      component: (
        <div className="Div">
          As vacinas têm eficácia variável. Dos estudos em fase 3, temos as vacinas de RNA com eficácia entre 90-95%. A vacina do laboratório Astra-Zeneca (Oxford) gira em torno de 70%. O mais importante é que todas as vacinas têm alta eficácia na proteção de infecções graves. A efetividade da vacina (na vida real), especialmente em populações específicas (idosos, imunossuprimidos) ainda deve ser avaliada.
        </div>
      ),
      trigger: 'ajudaVacina',
    },
    {
      ...
      component: (
        <div className="Div">
          Nenhuma vacina é 100% segura. Eventos raros vão ocorrer à medida que centenas de milhares de pessoas são vacinadas. Os eventos adversos mais comuns são dor no local da injeção, cansaço, mal estar e dores musculares dentro de alguns dias após a vacinação. Estes eventos podem ser controlados com uso de analgésicos como paracetamol. 
        </div>
      ),
      trigger: 'ajudaVacina',
    },
    {
      ...
      component: (
        <div className="Div">
          A única contra-indicação absoluta é reação alérgica a algum componente da vacina. Se o paciente apresentar uma reação alérgica grave à primeira dose da vacina, não deve receber a segunda dose. Pessoas que participaram de estudos com plasma convalescentes ou anticorpos monoclonais devem postergar o uso da vacina, devido à possível menor eficácia da vacina relacionada a estes procedimentos.
        </div>
      ),
      trigger: 'ajudaVacina',
    },
    {
      ...
      component: (
        <div className="Div">
          Estas pessoas apresentam um risco maior de apresentar complicações relacionadas a COVID-19. Portanto, recomenda-se que sejam vacinadas, embora possa haver risco de menor eficácia da vacina. O número de participantes com alguma imunodeficiência foi pequeno nos estudos, o que impede conclusões definitivas neste grupo de pessoas. 
        </div>
      ),
      trigger: 'ajudaVacina',
    },
    ...
    },
    {
      ...
      component: (
        <div className="Div">
          Não, esta é uma notícia falsa publicada nas mídias sociais. Nenhuma vacina aprovada, para uso no Brasil ou no mundo, irá alterar o DNA das pessoas vacinadas. 
        </div>
      ),
      trigger: 'ajudaVacina',
    },
    {
      ...
      component: (
        <div className="Div">
          Não. As vacinas atualmente liberadas ou em testes não são de vírus vivo ou vírus vivo atenuado, portanto, não há possibilidade de causar COVID-19.
        </div>
      ),
      trigger: 'ajudaVacina',
    },
    {
      ...
      component: (
        <div className="Div">
          Os eventos adversos mais comuns são dor no local da injeção, cansaço, mal estar e dores musculares dentro de alguns dias após a vacinação. Estes eventos podem ser controlados com uso de analgésicos como paracetamol. Geralmente os sintomas são mais comuns nos jovens. 
        </div>
      ),
      trigger: 'ajudaVacina',
    },
    {
      ...
      component: (
        <div className="Div">
          Qualquer pessoa com idade superior a 18 anos poderá se vacinar, quando a vacina estiver disponível e conforme cronograma estabelecido pelas autoridades sanitárias. Na fase 1 do plano de vacinação, estão os grupos prioritários como os trabalhadores da área da saúde, pessoas de 60 anos ou mais que vivem em instituições de longa permanência, população indígena e idosos a partir dos 75 anos.
        </div>
      ),
      trigger: 'ajudaVacina',
    },
    {
      ...
      component: (
        <div className="Div">
          Conforme definição do plano nacional de vacinação, grupos como gestantes, puérperas e lactantes, pacientes portadores de doenças reumáticas, oncológicos, transplantados e demais imunossuprimidos não foram avaliados nos estudos quanto à segurança e à eficácia da vacina, devendo essa ser realizada após avaliação cautelosa dos riscos e dos benefícios com decisão compartilhada entre o indivíduo e seu médico assistente. O plano também não engloba as crianças devido à falta de estudos e evidências que demonstrem a segurança neste grupo de pessoas.
        </div>
      ),
      trigger: 'ajudaVacina',
    },
    {
      ...
      component: (
        <div className="Div">
          Você deve tomar a que estiver disponível para você, pois todas elas foram aprovadas e passaram por rígidos padrões científicos para serem liberadas. Além disso, todas oferecem ótima eficácia na proteção contra infecções moderadas e graves. 
        </div>
      ),
      trigger: 'ajudaVacina',
    },
    {
      ...
      component: (
        <div className="Div">
          Até o momento, as vacinas estudadas estão sendo utilizadas em duas doses. A primeira, que estimula o sistema imunológico inicialmente, e a segunda, que serve como um segundo estímulo (booster) para aumentar a taxa de proteção e torná-la mais duradoura. A segunda dose deve ser da mesma vacina administrada previamente. 
        </div>
      ),
      trigger: 'ajudaVacina',
    },
    ...
    },
    {
      ...
      component: (
        <div className="Div">
          Não há uma informação precisa a este respeito. Especialistas estão trabalhando para aprender mais sobre a imunidade natural e a imunidade induzida pela vacina. 
        </div>
      ),
      trigger: 'ajudaVacina',
    },
    {
      ...
      component: (
        <div className="Div">
          Não há recomendação de se fazer nenhum teste para comprovação da presença de anticorpos contra o vírus após a vacinação. O sistema imunológico começa a demonstrar resposta dentro de 10-14 dias depois da vacinação. A ausência de anticorpos não significa falha na proteção, pois outras rotas do sistema imunológico podem ser ativadas para atuar contra o vírus, mesmo na ausência de resposta humoral (IgG). 
        </div>
      ),
      trigger: 'ajudaVacina',
    },
    {
      ...
      component: (
        <div className="Div">
          Sim, estas pessoas devem receber a vacina. A pessoa deve ter se recuperado totalmente da infecção para realizar a vacina. Como novas infecções são raras em pacientes com COVID-19 dentro de 90 dias da primeira infecção, recomenda-se aguardar este período para aplicação da vacina. 
        </div>
      ),
      trigger: 'ajudaVacina',
    },
    {
      ...
      component: (
        <div className="Div">
          A vacina não altera os testes de RT-PCR ou os testes de antígeno para diagnóstico de infecção aguda. Elas geram anticorpos contra a proteína S (Spike) do SARS-CoV-2. Alguns testes sorológicos detectam estes anticorpos e outros não. Os fabricantes dos testes devem informar sobre esta particularidade do produto. 
        </div>
      ),
      trigger: 'ajudaVacina',
    },
    {
      ...
      component: (
        <div className="Div">
          As pessoas que receberam as duas doses da vacina e aguardaram o tempo para haver a resposta do sistema imunológico (2-4 semanas após a segunda dose) poderão conviver com seus familiares próximos, fazer jantares, abraçar seus netos, eventos/atitudes que um não-vacinado não pode. Apesar disso,  até que tenhamos um contingente grande de vacinados e redução das taxas de infecção, as medidas de uso de máscara e distanciamento permanecerão, especialmente em um cenário de novas variantes virais.
        </div>
      ),
      trigger: 'ajudaVacina',
    },
    ...
    },
    {
      ...
      options: [
        ...
        { value: 7, label: 'Voltar', trigger: 'menuCovid19'},
      ],
    },
    {
      id: 'prevencaoCovid',
      component: (
        <div className="Div">
          O uso universal de máscara, além das outras medidas de saúde pública recomendadas (distanciamento, higiene de mãos), deve ser prioridade enquanto não houver um número suficiente de pessoas vacinadas para conter a disseminação do vírus. 
        </div>
      ),
    ...
    },
    {
      ...
      component: (
        <div className="Div">
          Na comunidade, o objetivo principal do mascaramento universal é o controle da fonte emissora de gotículas. Assim, máscaras de tecido (reutilizáveis) ou máscaras cirúrgicas (descartáveis) podem e devem ser utilizadas. 
        </div>
      ),
      trigger: 'ajudaMedidasPreventivas',
    },
    {
      ...
      component: (
        <div className="Div">
          Em caso de uso prolongado, o recomendado é trocar a máscara a cada 3 horas. Já em casos de saídas rápidas, como ir ao mercado ou farmácia, recomenda-se a troca diária. A máscara também deve ser trocada sempre que estiver molhada devido à tosse, ao espirro, à fala ou à respiração.
        </div>
      ),
      trigger: 'ajudaMedidasPreventivas',
    },
    {
      ...
      component: (
        <div className="Div">
          A máscara deve ser lavada com água e sabão, em água corrente, individualmente e, após, deve ser deixada de molho, por 20 a 30 minutos, em uma solução de água sanitária, contendo duas colheres de sopa do produto para 1L de água ou 1 colher de sopa para 500 ml. Também deve-se enxaguar bem em água corrente e deixar secar ao ar livre. 
        </div>
      ),
      trigger: 'ajudaMedidasPreventivas',
    },
    {
      ...
      component: (
        <div className="Div">
          As máscaras cirúrgicas são efetivas em 89% na filtragem de partículas de 0,2 micrômetros, enquanto que as máscaras N95 filtram partículas menores que 0,05 micrômetros em 95-99% das vezes. As máscaras N95 têm uma vedação melhor ao rosto. Ambas são indicadas para uso por profissionais de saúde nos seus locais de trabalho.
        </div>
      ),
      trigger: 'ajudaMedidasPreventivas',
    },
    {
      ...
      component: (
        <div className="Div">
          Dependendo do tecido, a capacidade de filtragem é diferente. A efetividade contra partículas de 0,02 micrômetros é a seguinte: tecido de saco de aspirador de pó (86%), pano de prato (72%), camiseta (70%), fronha de travesseiro (57-68%), linho (62%), seda (54%), camiseta 100% algodão (51%), cachecol (57%). 
        </div>
      ),
      trigger: 'ajudaMedidasPreventivas',
    },
    ...
    },
    {
      ...
      component: (
        <div className="Div">
          A higienização das mãos pode ser realizada utilizando água e sabonete ou álcool gel. A escolha de um produto ou outro dependerá da situação e disponibilidade. A água e o sabonete são sempre recomendados quando as mãos estiverem visivelmente sujas. Já o álcool gel poderá ser utilizado em todas as outras situações, já que é mais fácil de estar prontamente disponível em qualquer lugar. 
        </div>
      ),
    ...
    },
    {
      ...
      component: (
        <div className="Div">
          A higienização das mãos com preparações alcoólicas e com água e sabão são eficazes. Entretanto, alguns estudos mostram que o álcool gel pode ser mais efetivo que a higienização com água e sabonete, por ter uma ação bactericida e virucida que o sabonete comum não tem.
        </div>
      ),
      trigger: 'ajudaHigieneDasMaos',
    },
    {
      ...
      component: (
        <div className="Div">
          A​plique uma quantidade suficiente de preparação alcoólica em uma das mãos. Friccione as palmas, o dorso, entre os dedos, polpas digitais, polegares, unhas e punhos. Quando estiverem secas, suas mãos estarão seguras.
        </div>
      ),
      trigger: 'ajudaHigieneDasMaos',
    },
    {
      ...
      component: (
        <div className="Div">
          Abra a torneira e molhe as mãos. Na palma da mão, aplique quantidade suficiente de sabonete líquido. Friccione ou ensaboe as palmas, o dorso, entre os dedos, polpas digitais, polegares, unhas e punhos. Enxague as mãos, retirando os resíduos dos dedos para os punhos. Evite contato direto das mãos ensaboadas com a torneira. Enxugue as mãos com papel toalha. Feche a torneira com papel toalha. Nunca use as mãos para fechar as torneiras. 
        </div>
      ),
      trigger: 'ajudaHigieneDasMaos',
    },
    {
      ...
      component: (
        <div className="Div">
          Quando estiverem visivelmente sujas. Após usar transporte público. Após ir ao banheiro. Após tossir ou espirrar. Antes de preparar refeições. Antes de se alimentar. Antes e após cuidar de alguém doente. Ao chegar em casa. Ao chegar em algum lugar público, como restaurante, farmácia ou supermercado. Ao sair de algum lugar público. Antes de tocar olhos, nariz ou boca. Na prática, esta ação deve ser realizada sempre que se considerar a possibilidade de contaminação das mãos. 
        </div>
      ),
      trigger: 'ajudaHigieneDasMaos',
    },
    ...
    },
    {
      ...
      component: (
        <div className="Div">
          Até o momento, sabe-se que o SARS-CoV-2 pode permanecer viável em diversas superfícies por períodos de tempo variáveis. Entretanto, esta não é a principal via de transmissão da COVID-19.  A forma mais comum de transmissão é por meio das gotículas respiratórias. Isto não elimina a necessidade de cuidados e limpeza do ambiente, já que a transmissão indireta pode ocorrer, porém é menos provável.
        </div>
      ),
    ...
    },
    {
      ...
      component: (
        <div className="Div">
          Não, uma vez que as roupas não entram em contato direto com as nossas mucosas (boca, nariz e olhos). Estudos demonstraram que  as roupas de profissionais de saúde que cuidavam de pacientes com COVID-19, em hospitais, não ofereciam riscos na transmissão por não conterem partículas virais. 
        </div>
      ),
      trigger: 'ajudaLimpezaDoAmbiente',
    },
    {
      ...
      component: (
        <div className="Div">
          Não há comprovação de transmissão da infecção por alimentos. O ambiente também tem menor importância na transmissão. Ainda,  produtos utilizados no ambiente doméstico podem não ser adequados para a desinfecção de embalagens. Reforça-se a necessidade de se manter as superfícies domésticas limpas, além da higienização das mãos sempre após tocar embalagens e antes de preparar os alimentos. 
        </div>
      ),
      trigger: 'ajudaLimpezaDoAmbiente',
    },
    {
      ...
      component: (
        <div className="Div">
          Não. Não há comprovação científica de que os tapetes sanitizantes sejam efetivos na redução da transmissão da COVID-19. Além disso, os sapatos não estão associados à transmissão da COVID-19. Após tocar sapatos ou pegar qualquer objeto que tenha caído, devemos higienizar as nossas mãos. 
        </div>
      ),
      trigger: 'ajudaLimpezaDoAmbiente',
    },
    {
      ...
      component: (
        <div className="Div">
          Locais com maior número de pessoas em que o distanciamento não possa ser mantido. Locais onde haja uma menor renovação de ar. Ambientes fechados, como restaurantes onde haja a necessidade de retirada das máscaras. Além das instituições de saúde ou instituições de longa permanência. 
        </div>
      ),
      trigger: 'ajudaLimpezaDoAmbiente',
    },
    ...
    },
    {
      ...
      component: (
        <div className="Div">
          Qualquer pessoa pode ter sintomas leves ou graves. As manifestações mais comuns são febre (44-94%),  tosse (68-83%), dores do corpo (11-63%), sintomas de via aérea superior ( dor de garganta, congestão nasal, nariz escorrendo - 5-61%),  falta de ar (11-40%), cansaço (23-38%), dor de cabeça (8-14%), náusea ou vômitos ou diarreia (3-17%) e confusão mental (9%). A perda do olfato e do paladar (70%) estão mais associados com a COVID-19 do que com outros vírus. Dezessete a 20% das pessoas não apresentam sintomas apesar de estarem infectadas.
        </div>
      ),
    ...
    },
    {
      ...
      component: (
        <div className="Div">
          Sempre que você estiver com muitos sintomas, seria ideal buscar auxílio médico. Os sintomas que significam maior gravidade são dificuldade para respirar, fala entrecortada, cansaço aos esforços mínimos, dor no peito persistente, dificuldade de permanecer acordado, palidez ou confusão mental. 
        </div>
      ),
      trigger: 'ajudaSintomas',
    },
    {
      ...
      component: (
        <div className="Div">
          Contate seu médico de confiança ou busque os locais de atendimento de seu convênio ou o posto de saúde de sua região. Os postos de saúde estão equipados com insumos para o diagnóstico adequado da COVID-19.
        </div>
      ),
      trigger: 'ajudaSintomas',
    },
    {
      ...
      component: (
        <div className="Div">
          Sim, é importante permanecer em isolamento domiciliar até ter certeza de que você está infectado. Caso confirme o diagnóstico, você deve permanecer em isolamento por aproximadamente 10 dias, a contar do começo dos sintomas, se estiver com melhora clínica. 
        </div>
      ),
      trigger: 'ajudaSintomas',
    },
    {
      ...
      component: (
        <div className="Div">
          Em média, os sintomas se desenvolvem entre o segundo e o sétimo dia do contato. Em torno de 95% dos pacientes já desenvolveram sintomas com 12 dias de contato. Catorze dias é o prazo final para desenvolvimento de sintomas a partir do dia de contato.  
        </div>
      ),
      trigger: 'ajudaSintomas',
    },
    ...
    },
    {
      ...
      component: (
        <div className="Div">
          Se você convive na mesma casa de um caso positivo, você é considerado contato. Ou se você estiver próximo de um caso positivo,  a distância de 2 metros ou menos, por pelo menos 15 minutos. 
        </div>
      ),
    ...
    },
    {
      ...
      component: (
        <div className="Div">
          O convívio familiar é a situação de maior risco de transmissão, com taxa de transmissão em torno de 30%. Portanto, se alguém da sua casa estiver doente, você deve ficar, por precaução, em casa por até 14 dias do início dos sintomas da pessoa doente. Caso você manifeste algum sintoma, realize o teste de RT-PCR.
        </div>
      ),
      trigger: 'ajudaContato',
    },
    ...
    },
    {
      ...
      component: (
        <div className="Div">
          De uma forma geral, para detecção da infecção, temos os testes sorológicos que medem anticorpos; os testes de antígenos que são partículas ou substâncias do vírus que estimulam o sistema imunológico e os testes moleculares (RT-PCR), que também detectam o RNA  do vírus e são considerados o padrão-ouro para o diagnóstico.
        </div>
      ),
      trigger: 'ajudaTestes',
    },
    {
      ...
      component: (
        <div className="Div">
          Consulte um profissional para ver a melhor opção de testagem. A presença ou ausência de sintomas e o tempo de infecção influenciam  o resultado do teste e, portanto, a melhor escolha deste. Os testes moleculares (RT-PCR), que também detectam o RNA  do vírus, são considerados o padrão-ouro para o diagnóstico de infecção aguda.
        </div>
      ),
      trigger: 'ajudaTestes',
    },
    {
      ...
      component: (
        <div className="Div">
          Os testes sorológicos detectam anticorpos, portanto servem principalmente para identificação de infecção passada. Estes geralmente positivam após a primeira semana (IgM), mas, especialmente, após a terceira e quarta semanas (IgM e IgG) a partir do início dos sintomas. Os testes de antígenos e RT-PCR fazem a detecção da infecção aguda. 
        </div>
      ),
      trigger: 'ajudaTestes',
    },
    {
      ...
      component: (
        <div className="Div">
          Ambos servem para detecção de infecção aguda. O RT-PCR é o padrão ouro por ser mais sensível e específico. Os testes de antígeno são mais rápidos para se ter o resultado e mais baratos também, mas perdem um pouco de sensibilidade. Por exemplo, um teste de antígeno positivo em um paciente assintomático ou  um teste negativo em um paciente sintomático devem ser confirmados por um RT-PCR.
        </div>
      ),
      trigger: 'ajudaTestes',
    },
    {
      ...
      component: (
        <div className="Div">
          Depende muito do teste realizado. Os testes sorológicos, conforme o tempo de infecção, podem ter altos índices de falsos negativos. Os testes de antígeno são mais rápidos para se ter o resultado e são mais baratos também, mas perdem um pouco de sensibilidade. Por exemplo, um teste de antígeno positivo em um paciente assintomático ou  um teste negativo em um paciente sintomático devem ser confirmados por um RT-PCR
        </div>
      ),
      trigger: 'ajudaTestes',
    },
    {
      ...
      options: [
        ...
        { value: 4, label: 'Voltar', trigger: 'menuCovid19'},
      ],
    },
    {
      id: 'testeComSintomas',
      component: (
        <div className="Div">
          Deve realizar o teste caso você esteja com sintomas gripais. O teste é mais preciso  a partir do segundo ao quinto dia de sintomas.
        </div>
      ),
      trigger: 'ajudaTestes',
    },
    {
      ...
      component: (
        <div className="Div">
          Se você é contactante de um caso positivo, você pode realizar o teste de RT-PCR de secreção nasal e orofaringe para diagnóstico. Alguns casos de infecção cursam sem sintomas ou com sintomas mínimos. Recomenda-se então a realização do teste a partir do quinto dia de contato.
        </div>
      ),
      trigger: 'ajudaTestes',
    },
    {
      ...
      component: (
        <div className="Div">
          Se você está assintomático, nem teve contato com alguém positivo, o teste pode trazer resultados falsos. Em uma pessoa assintomática, o resultado de RT-PCR pode ser falso-negativo em 100 a 60% das vezes em um paciente infectado. Assim, muito cuidado ao interpretar este resultado nessa situação.
        </div>
      ),
      trigger: 'ajudaTestes',
    },
    ...
    },
    {
      ...
      component: (
        <div className="Div">
          Caso você tenha suspeita de COVID-19 e seu teste deu negativo, deve-se analisar qual teste foi realizado e em que momento foi realizado. Se você fez um teste de RT-PCR na vigência dos sintomas, entre o segundo e o quinto dia, e este foi negativo, provavelmente seus sintomas não são devidos à COVID-19, mas talvez outro vírus.  Caso você tenha feito teste de antígeno ou sorologia e este foi negativo, ele deve ser confirmado com um RT-PCR. 
        </div>
      ),
      trigger: 'ajudaTempoDeIsolamento',
    },
    {
      ...
      component: (
        <div className="Div">
          Não recomenda-se a testagem do paciente como critério para sair do isolamento. Muitos pacientes permanecem com detecção de RNA viral nas vias aéreas superiores por semanas ou meses.  Estudos não demonstraram vírus viáveis após o nono dia de infecção. 
        </div>
      ),
      trigger: 'ajudaTempoDeIsolamento',
    },
    ...
    },
    {
      ...
      options: [
        ...
        { value: 3, label: 'Voltar', trigger: 'menuCovid19'},
      ],
    },
    {
      id: 'podeViajar',
      component: (
        <div className="Div">
          Sim, embora não seja recomendado viajar durante a pandemia, a não ser que sejam situações necessárias. Com relação às viagens aéreas, deve-se seguir orientações básicas de precaução como manter um distanciamento mínimo de 1,5 m no embarque e desembarque, utilizar máscara de tecido ou cirúrgica durante toda a viagem, cobrindo adequadamente a boca e o nariz, evitar a circulação dentro da aeronave e higienizar as mãos sempre que possível.
        </div>
      ),
    ...
    },
    {
      ...
      options: [
        ...
        { value: 4, label: 'Voltar', trigger: 'menuPrincipal'},
      ],
    },
    {
      id: 'variantes',
      component: (
        <div className="Div">
          Os vírus mudam constantemente por meio de mutações e novas variantes são esperadas ao longo do tempo. Até o momento, três novas variantes do SARS-CoV-2 são conhecidas: B.1.1.7, identificada no Reino Unido; B.1.352, identifica na África do Sul; e P.1, identificada no Brasil. Estas variantes parecem disseminar mais fácil e rapidamente de pessoa para pessoa. Entretanto, outras questões como a possibilidade de causar doença moderada ou severa ou mudar a efetividade das vacinas ainda estão sendo estudadas.        
        </div>
      ),
      trigger: 'ajudaGeral',
    },
    ...
    },
    {
      ...
      component: (
        <div className="Div">
          Notícias sobre a COVID-19 podem ser encontradas no nosso site, basta clicar <a href="https://www.portalqualis.com.br/covid-19/" className="DivLink">aqui</a> para acessar.
        </div>
      ),
      trigger: 'ajudaGeral',
    },
    ...
    },
    {
      ...
      options: [
        ...
        { value: 5, label: 'Voltar', trigger: 'menuPrincipal'},
      ],
    },
    {
      id: 'contato',
      component: (
        <div className="Div">
          Você pode entrar em contato conosco pelo número (51) 3028-4992, pelo <a href="https://api.whatsapp.com/send/?phone=+555197748691&text&app_absent=0" className="DivLink">WhatsApp</a> ou pelo nosso <a href="https://www.portalqualis.com.br/contato/" className="DivLink">site</a>.
        </div>
      ),
      trigger: 'ajudaQualis',
    },
    {
      ...
      component: (
        <div className="Div">
          Os serviços ofertados pela Qualis são os seguintes: consultoria para ambientes seguros, teleinfectologia e televigilância das infecções hospitalares. Para saber mais sobre esses serviços, clique <a href="https://www.portalqualis.com.br/servicos/" className="DivLink">aqui</a>.
        </div>
      ),
      trigger: 'ajudaQualis',
    },
    {
      ...
      component: (
        <div className="Div">
          Os produtos da Qualis são os seguintes: Vigilância Móvel (Mobilidade nos Pacotes de Prevenção de Infecção Hospitalar) e Robô ISA (Robô de Busca Ativa de Infecções Hospitalares). Para saber mais sobre esses produtos, clique <a href="https://www.portalqualis.com.br/produtos/" className="DivLink">aqui</a>.
        </div>
      ),
      trigger: 'ajudaQualis',
    },
    {
      ...
      component: (
        <div className="Div">
          Você pode consultar outras informações diretamente no nosso site, basta clicar <a href="https://www.portalqualis.com.br/" className="DivLink">aqui</a>!
        </div>
      ),
      trigger: 'ajudaQualis',
    },
